			...
			<fieldset class="AlignFieldset">
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" id="userName" size="20" maxlength="25"
					...
					<tr>
						...
						<td><select style="width: 200px"
							name="selectedProjectName" id="selectedProjectName"
							onclick="checkProjectName1()">
					...
					<tr>
						<td align="right"><a href="LoginPage.jsp"><input
								type="button" value="Login Page" id="NormalButton"
