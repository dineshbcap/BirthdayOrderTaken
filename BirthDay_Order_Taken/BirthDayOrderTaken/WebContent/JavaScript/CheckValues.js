...
function checkProjectName1(){
	if(document.getElementById("selectedsName").value=="-select-"){
		document.getElementById('projectMsg').innerHTML="Please select the Project";
		document.getElementById('projectMsg').style.color="red";
		return false;
	}
	else{
