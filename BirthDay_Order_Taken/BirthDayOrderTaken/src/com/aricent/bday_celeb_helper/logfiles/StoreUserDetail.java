package com.aricent.bday_celeb_helper.logfiles;
...
public class StoreUserDetail {
	...
	public static void storeUserInfo(String message) throws IOException {
		PropertyConfigurator
				.configure(System.getProperty("user.dir")+"/src/com/aricent/bday_celeb_helper/logfiles/TrackUserDetail.properties");
